...
(function () {
    ...
    scriptNode.onaudioprocess = function(audioProcessingEvent) {
        ...
        if (count == 10) {
            ...
            document.getElementById('list').innerHTML += "Note - " + note.name + " : " + note.frequency +
                " Pitch detected: " + pitchDetected + "Cents Off: " + pEval.getCentsDiff(pitchDetected, note.name) +
                "<br>";
                //+ "<br><br>" +
